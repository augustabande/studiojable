...
const PricingSection = ({ filterName }) => {
    console.log("filterName:", filterName);
    const itemsToShow = filterName
        ? Data.items.filter(item => item.id === filterName)
        : Data.items;
    const isSingle = !!filterName;
    return (
    <>
    {isSingle ? (
        // 👉 Layout SINGOLO (es. nel dettaglio di un servizio)
                ...
                <div className="row justify-content-between mil-mb-120">
                    ...
                    <div className="col-xl-6">
                        ...
                        {itemsToShow.map((item, key) => (
                            ...
                            <div className="col-lg-8" key={`pricing-item-${key}`}>
      ...
      // 👉 Layout COMPLETO (pagina generale)
